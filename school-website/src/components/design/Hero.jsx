...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      ...
      <MouseParallax enableOnTouchDevice isAbsolutelyPositioned strength={0.03} parallaxContainerRef={parallaxRef}>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[46deg]" strength={0.07} >
          <div
        ...
        <MouseParallax enableOnTouchDevice isAbsolutelyPositioned strength={0.10} parallaxContainerRef={parallaxRef}>
        ...
        <MouseParallax enableOnTouchDevice isAbsolutelyPositioned strength={0.06} parallaxContainerRef={parallaxRef}>
        ...
        <MouseParallax enableOnTouchDevice isAbsolutelyPositioned strength={0.15} parallaxContainerRef={parallaxRef}>
